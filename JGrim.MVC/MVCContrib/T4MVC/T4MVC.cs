...
public static class MVC {
    ...
    public static JGrim.MVC.Controllers.DefaultController Default = new JGrim.MVC.Controllers.T4MVC_DefaultController();
    public static JGrim.MVC.Controllers.HomeController Home = new JGrim.MVC.Controllers.T4MVC_HomeController();
    public static JGrim.MVC.Controllers.LoginController Login = new JGrim.MVC.Controllers.T4MVC_LoginController();
    public static JGrim.MVC.Controllers.PagesController Pages = new JGrim.MVC.Controllers.T4MVC_PagesController();
    public static JGrim.MVC.Controllers.PhotoAlbumsController PhotoAlbums = new JGrim.MVC.Controllers.T4MVC_PhotoAlbumsController();
    public static JGrim.MVC.Controllers.PhotosController Photos = new JGrim.MVC.Controllers.T4MVC_PhotosController();
...
namespace T4MVC {
    ...
    public class AdminClass {
        ...
        public JGrim.MVC.Areas.Admin.Controllers.DefaultController Default = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_DefaultController();
        public JGrim.MVC.Areas.Admin.Controllers.HomeController Home = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_HomeController();
        public JGrim.MVC.Areas.Admin.Controllers.LoginController Login = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_LoginController();
        public JGrim.MVC.Areas.Admin.Controllers.PagesController Pages = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_PagesController();
        public JGrim.MVC.Areas.Admin.Controllers.PhotoAlbumsController PhotoAlbums = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_PhotoAlbumsController();
        public JGrim.MVC.Areas.Admin.Controllers.PhotosController Photos = new JGrim.MVC.Areas.Admin.Controllers.T4MVC_PhotosController();
...
namespace Links {
    ...
    public static class Scripts {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class jquery_loadmask {
            private const string URLPATH = "~/Scripts/jquery-loadmask";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class images {
                private const string URLPATH = "~/Scripts/jquery-loadmask/images";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string loading_gif = Url("loading.gif");
            }
        
            public static readonly string jquery_loadmask_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.loadmask.min.js") ? Url("jquery.loadmask.min.js") : Url("jquery.loadmask.js");
                          
            public static readonly string jquery_loadmask_min_js = Url("jquery.loadmask.min.js");
        }
    
        public static readonly string jquery_ui_1_8_9_custom_min_js = Url("jquery-ui-1.8.9.custom.min.js");
        ...
        public static class PageSpecific {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string AdminMaster_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/AdminMaster.min.js") ? Url("AdminMaster.min.js") : Url("AdminMaster.js");
                          
            public static readonly string PageAdmin_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/PageAdmin.min.js") ? Url("PageAdmin.min.js") : Url("PageAdmin.js");
                          
            public static readonly string PhotoAlbum_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/PhotoAlbum.min.js") ? Url("PhotoAlbum.min.js") : Url("PhotoAlbum.js");
                          
            public static readonly string Photos_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Photos.min.js") ? Url("Photos.min.js") : Url("Photos.js");
    ...
    public static class Content {
        ...
        public static class custom_theme {
            private const string URLPATH = "~/Content/custom-theme";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class images {
                private const string URLPATH = "~/Content/custom-theme/images";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string ui_bg_flat_0_aaaaaa_40x100_png = Url("ui-bg_flat_0_aaaaaa_40x100.png");
                public static readonly string ui_bg_flat_50_4d4d4d_40x100_png = Url("ui-bg_flat_50_4d4d4d_40x100.png");
                public static readonly string ui_bg_flat_75_f7f7f7_40x100_png = Url("ui-bg_flat_75_f7f7f7_40x100.png");
            ...
            public static readonly string jquery_ui_1_8_9_custom_css = Url("jquery-ui-1.8.9.custom.css");
        }
    
        public static readonly string nyroModal_css = Url("nyroModal.css");
