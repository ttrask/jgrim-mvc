...
namespace JGrim.MVC.Areas.Admin.Controllers {
    public partial class PhotosController {
        ...
        public class ViewNames {
            public readonly string Admin = "~/Areas/Admin/Views/Photos/Admin.aspx";
            public readonly string Albums = "~/Areas/Admin/Views/Photos/Albums.aspx";
            public readonly string Index = "~/Areas/Admin/Views/Photos/Index.aspx";
            public readonly string Pager = "~/Areas/Admin/Views/Photos/Pager.ascx";
            public readonly string PhotoAlbum = "~/Areas/Admin/Views/Photos/PhotoAlbum.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PhotosController: JGrim.MVC.Areas.Admin.Controllers.PhotosController {
