...
namespace JGrim.MVC.Areas.Admin.Controllers {
    public partial class PhotoAlbumsController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PhotoAlbumsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PhotoAlbumsController Actions { get { return this; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PhotoAlbums";
        ...
        public class ViewNames {
            public readonly string Albums = "~/Areas/Admin/Views/PhotoAlbums/Albums.aspx";
            public readonly string Details = "~/Areas/Admin/Views/PhotoAlbums/Details.ascx";
            public readonly string Edit = "~/Areas/Admin/Views/PhotoAlbums/Edit.ascx";
            public readonly string Index = "~/Areas/Admin/Views/PhotoAlbums/Index.aspx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PhotoAlbumsController: JGrim.MVC.Areas.Admin.Controllers.PhotoAlbumsController {
        public T4MVC_PhotoAlbumsController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult Admin(int? id) {
