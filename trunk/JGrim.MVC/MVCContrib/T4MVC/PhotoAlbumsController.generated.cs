...
namespace JGrim.MVC.Controllers {
    public partial class PhotoAlbumsController {
        ...
        public class ViewNames {
            public readonly string Admin = "~/Views/PhotoAlbums/Admin.aspx";
            public readonly string Albums = "~/Views/PhotoAlbums/Albums.aspx";
            public readonly string Index = "~/Views/PhotoAlbums/Index.aspx";
            public readonly string PhotoAlbum = "~/Views/PhotoAlbums/PhotoAlbum.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PhotoAlbumsController: JGrim.MVC.Controllers.PhotoAlbumsController {
