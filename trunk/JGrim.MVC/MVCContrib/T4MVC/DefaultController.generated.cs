...
namespace JGrim.MVC.Controllers {
    public partial class DefaultController {
        ...
        public class ViewNames {
            public readonly string Admin = "~/Views/Default/Admin.aspx";
            public readonly string Index = "~/Views/Default/Index.aspx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_DefaultController: JGrim.MVC.Controllers.DefaultController {
