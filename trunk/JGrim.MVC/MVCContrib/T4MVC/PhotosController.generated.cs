...
namespace JGrim.MVC.Controllers {
    public partial class PhotosController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult Albums() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.Albums);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PhotosController Actions { get { return this; } }
        ...
        public class ViewNames {
            public readonly string Admin = "~/Views/Photos/Admin.aspx";
            public readonly string Albums = "~/Views/Photos/Albums.aspx";
            public readonly string Index = "~/Views/Photos/Index.aspx";
            public readonly string PhotoAlbum = "~/Views/Photos/PhotoAlbum.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PhotosController: JGrim.MVC.Controllers.PhotosController {
        public T4MVC_PhotosController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Albums(string ID) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Albums);
